...
RUN export PIP_EXTRA_INDEX_URL=https://mirrors.huaweicloud.com/ascend/repos/pypi && \
    ...
    if [ -f /vllm-workspace/vllm-ascend/vllm_ascend/.build_cache_marker ]; then \
        COMPILE_CUSTOM_KERNELS=0 python3 -m pip install -v -e /vllm-workspace/vllm-ascend/ --extra-index https://download.pytorch.org/whl/cpu/ ; \
    else \
